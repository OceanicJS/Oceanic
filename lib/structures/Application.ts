...
export default class Application extends ClientApplication {
    ...
    description: string;
    /** If this application is a game sold on Discord, the guild to which it has been linked. This will only be present if recieved via `/applications/@me` {@link Routes/Miscellaneous~Miscellaneous.getApplication | Miscellaneous#getApplication}). */
