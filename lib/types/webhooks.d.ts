...
export interface RawWebhook {
    ...
    id: string;
    name: string | null;
    source_channel?: Pick<Types.Channels.RawChannel, "id" | "name">;
    source_guild?: Pick<Types.Guilds.RawGuild, "id" | "name" | "icon">;
    token?: string;
    type: WebhookTypes;
    url?: string;
...
export interface ExecuteWebhookOptions extends Pick<Types.Channels.CreateMessageOptions, "content" | "tts" | "embeds" | "allowedMentions" | "components" | "attachments" | "flags" | "files" | "poll"> {
...
export interface EditWebhookMessageOptions extends Types.Shared.Nullable<Pick<ExecuteWebhookOptions, "content" | "embeds" | "allowedMentions" | "components" | "attachments" | "threadID" | "files" | "flags">> {
    /** Polls can only be added when editing a deferred interaction response. */
    poll?: Types.Channels.MessagePollOptions;
}
