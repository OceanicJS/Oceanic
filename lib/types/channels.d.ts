...
export type PartialInteractionResolvedChannel = Omit<Required<Pick<RawChannel, "id" | "name" | "type" | "permissions">>, "name"> & { name: string; } & Pick<RawChannel, "thread_metadata" | "parent_id">;
