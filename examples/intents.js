...
const client = new Client({
    ...
    gateway: {
        ...
        // Most events also list if they require an intent: https://docs.oceanic.ws/latest/interfaces/ClientEvents.html
...
// New Guild Joined
// https://docs.oceanic.ws/latest/interfaces/ClientEvents.html#guildCreate
client.on("guildCreate", (guild) => {
    console.log("Guild Joined:", guild.name);
});

// Message Sent
// https://docs.oceanic.ws/latest/interfaces/ClientEvents.html#messageCreate
...
// https://docs.oceanic.ws/latest/interfaces/ClientEvents.html#typingStart
